...
(defun centaur-setup-fonts ()
  ...
  (when (display-graphic-p)
    ;; Set default font
    (cl-loop for font in '("Iosevka Custom" "Cascadia Code" "Fira Code" "Jetbrains Mono"
...
(custom-set-variables
 ...
 '(centaur-dashboard t)
 '(centaur-full-name "Torsten Schenkel")
 '(centaur-logo "~/.emacs.d/logo.png")
 '(centaur-mail-address "torsten@t-cubed.org.uk")
 '(centaur-org-directory "/home/thor/Org/")
 '(centaur-player t)
 '(centaur-theme 'night)
 '(centaur-theme-alist
   '((default . doom-one)
 ...
 '(safe-local-variable-values
   '((org-latex-default-position . "H")
     (org-download-heading-lvl)
     (org-download-image-dir . "./figures/attached")
